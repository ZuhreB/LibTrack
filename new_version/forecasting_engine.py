...
class ForecastingEngine:
    ...
    def run_best_slot_forecast(self, hourly_df, target_weekday, target_hour, exam_mode):
        """Tek bir slot için 4 modeli yarıştırır ve en iyisini seçer."""
        # Filtreleme
        ...
        # Güven aralığı ve Sınırlandırma
        sigma = best_err
    ...
    def run_prophet_weekly(self, hourly_df, exam_mode):
        """Prophet kütüphanesi ile haftalık tahmin üretir."""
